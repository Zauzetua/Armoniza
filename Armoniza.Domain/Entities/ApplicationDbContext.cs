...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<apartado>(entity =>
        {
            ...
            entity.HasOne(d => d.idUsuarioNavigation).WithMany(p => p.apartados)
        ...
        modelBuilder.Entity<detalleApartado>(entity =>
        {
            ...
            entity.HasOne(d => d.idApartadoNavigation).WithMany(p => p.detalleApartados)
                .HasForeignKey(d => d.idApartado)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_detalle_apartado");

            entity.HasOne(d => d.idInstrumentoNavigation).WithMany(p => p.detalleApartados)
        ...
        modelBuilder.Entity<detalleUsuario>(entity =>
        {
            ...
            entity.HasOne(d => d.idAspiranteNavigation).WithMany(p => p.detalleUsuarioidAspiranteNavigations)
                .HasForeignKey(d => d.idAspirante)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_detalle_aspirante");

            entity.HasOne(d => d.idDirectorNavigation).WithMany(p => p.detalleUsuarioidDirectorNavigations)
        ...
        modelBuilder.Entity<grupoDirector>(entity =>
        {
            ...
            entity.HasOne(d => d.idDirectorNavigation).WithMany(p => p.grupoDirectors)
                .HasForeignKey(d => d.idDirector)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_detalle_director");

            entity.HasOne(d => d.idGrupoNavigation).WithMany(p => p.grupoDirectors)
        ...
        modelBuilder.Entity<instrumento>(entity =>
        {
            ...
            entity.HasOne(d => d.idCategoriaNavigation).WithMany(p => p.instrumentos)
